...
/**
 * Created by ed on 29/12/15.
 */
public class EditLeapCard extends DialogFragment {

    private EditText leapNumberField, usernameField, emailField, passwordField;
    private CheckBox transformPassword;
    private setEditLeapListener editLeapDialogListener = null;

    String number, username, email, password;

    //listener that the corresponding button implements
    public interface setEditLeapListener {
        void onDoneClick(DialogFragment dialogFragment);
    }

    public void setEditLeapDialogListener(setEditLeapListener editLeapDialogListener) {
        this.editLeapDialogListener = editLeapDialogListener;
    }

    /**
     * onCreateDialog is a generic builder for generating a dialog
     * per row id given, such that tasks can be edited to the db
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
                ...
                .setPositiveButton("Done", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        if (editLeapDialogListener != null) {
                            editLeapDialogListener.onDoneClick(EditLeapCard.this);
                        }
                    }
                })
        ...
        leapNumberField.setText(getNumber());
    ...
    public void setNumberField(String data){this.number = data;}
    public void setUsernameField(String data){this.username = data;}
    public void setEmailField(String data){this.email = data;}
    public void setPasswordField(String data){this.password = data;}
